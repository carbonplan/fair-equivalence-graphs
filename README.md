...
A small set of functions designed to explore the temperature dynamics of perturbing the carbon cycle.
Current core functions were developed as part of exploring how ton-year accounting works.
